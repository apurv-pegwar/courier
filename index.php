...
?>
        <script>
            ...
            window.open('index.php', '_self');
                    ...
                    ?>
        <script>
            alert("TOOFANI COURIERS WELCOMES YOU 🙏");
...
<body>
    <h1 align='center' style="margin: 15px; color:seagreen;font-weight: bold;font-family:'Times New Roman', Times, serif">TOOFAAN COURIER SERVICE</h1>
    <hr />
